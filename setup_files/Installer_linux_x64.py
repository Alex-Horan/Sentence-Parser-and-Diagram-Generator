...
def spacyCMD():
    ...
    instSpacy = run(["cd ./Sentence-Parser; ./App/bin/python3 -m pip install setuptools wheel spacy; ./App/bin/python3 -m spacy download en_core_web_md;"], shell=True, capture_output=True)
